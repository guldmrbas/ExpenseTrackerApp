...
struct Transaction : Identifiable , Decodable , Hashable{
    let id: Int // İşlem ID'si
        let date: String // İşlem Tarihi
        let institution: String // İşlem Yapılan Kurum
        let account: String // İşlem Yapılan Hesap
        var merchant: String // Satıcı
        let amount: Double // İşlem Tutarı
        let type: TransactionType.RawValue // İşlem Türü
        var categoryId: Int // Kategori ID'si
        var category: String // Kategori
        let isPending: Bool // Beklemede mi?
        var isTransfer: Bool // Transfer İşlemi mi?
        var isExpense: Bool // Gider mi?
        var isEdited: Bool // Düzenlendi mi?
